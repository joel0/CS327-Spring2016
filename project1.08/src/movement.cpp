...
void generateShortestMove(dungeon_t* dungeonPtr, monster* monsterPtr, int* dstX, int* dstY);
void generateDirectMove(dungeon_t* dungeonPtr, monster* monsterPtr, int targetX, int targetY, int* dstX, int* dstY);
