...
public:
    ...
    monster(std::string name, std::string desc, int color, dice_set* speed_ptr, std::string abil, int HP, int DAM, char SYMB) {
        this->name = name;
        this->description = desc;
        this->color = color;
        this->speedPtr = speed_ptr;
        this->abilities = abil;
        this->HP = HP;
        this->DAM = DAM;
        this->symb = SYMB;
...
public:
    ...
    monster_evil(std::string name, std::string desc, int color, dice_set* speed_ptr, std::string abil, int HP, int DAM, char SYMB)
            : monster::monster(name, desc, color, speed_ptr, abil, HP, DAM, SYMB) {}
    char getChar();
};
